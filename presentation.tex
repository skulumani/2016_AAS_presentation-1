...
\only<2>{
    \begin{center}
        \includegraphics[width=0.3\textwidth]{figures/phi1.pdf}~
        \includegraphics[width=0.3\textwidth]{figures/phi2.pdf}~
        \includegraphics[width=0.3\textwidth]{figures/phi3.pdf}
    \end{center}
}
...
\begin{center}
  \animategraphics[autoplay,loop,width=0.5\textwidth]{30}{./animation/body/body-}{1}{1500}~\hfill
  \animategraphics[autoplay,loop,width=0.5\textwidth]{30}{./animation/inertial/inertial-}{1}{1500}
\end{center}
